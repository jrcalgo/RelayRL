...
pub use crate::agent::client::builder::ZmqTrainingAddressesArgs;
pub use crate::agent::builder::{
...
#[cfg(any(feature = "nats-transport", feature = "zmq-transport"))]
pub use crate::agent::client::builder::{InferenceAddressesArgs, TrainingAddressesArgs};
#[cfg(any(feature = "nats-transport", feature = "zmq-transport"))]
pub use crate::agent::client::builder::{InferenceParams, TrainingParams};
pub use crate::agent::runtime::actor::ActorInfo;
use crate::agent::runtime::control::coordinator::{
    ClientActors, ClientCoordinator, ClientEnvironments, ClientInterface, CoordinatorError,
    ToAnyBurnTensor,
};
use crate::agent::runtime::control::state_manager::ActorUuid;
#[cfg(any(feature = "nats-transport", feature = "zmq-transport"))]
use crate::agent::client::runtime::control::state_manager::StateManagerError;
            ...
            if let (
                ...
                let actor_entries: Vec<(String, String, Uuid)> = {
                    let client_namespace = self
                        ...
                        .client_namespace
                        .as_ref();
                    get_context_entries(client_namespace, crate::agent::ACTOR_CONTEXT)?
                };
