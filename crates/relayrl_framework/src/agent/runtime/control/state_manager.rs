...
use crate::agent::client::agent::AlgorithmInitArgs;
use crate::agent::process::ActorInfo;
use crate::agent::builder::{ActorInferenceMode, ClientModes, ModelMode};
use crate::agent::runtime::actor::LocalModelHandle;
use crate::agent::runtime::actor::{
    Actor, ActorEntity, ActorError, ActorRuntime, ErasedActorRuntime,
};
use crate::agent::runtime::control::coordinator::{CHANNEL_THROUGHPUT, ClientNamespace};
use crate::agent::runtime::control::lifecycle_manager::LifecycleManagerError;
#[cfg(any(feature = "nats-transport", feature = "zmq-transport"))]
use crate::agent::runtime::control::lifecycle_manager::SharedTransportAddresses;
use crate::agent::runtime::control::scale_manager::RouterNamespace;
use crate::agent::runtime::data::environments::EnvironmentInterface;
use crate::agent::runtime::data::environments::EnvironmentInterfaceError;
...
use crate::agent::runtime::data::training::{TrainingError, TrainingInterface};
#[cfg(feature = "metrics")]
...
pub enum StateManagerError {
    ...
    #[error(transparent)]
    ActorError(#[from] crate::agent::runtime::actor::ActorError),
}
...
impl<B: Backend + BackendMatcher<Backend = B>> StateManager<B> {
    ...
    pub(crate) fn remove_actor(&mut self, id: Uuid) -> Result<(), StateManagerError> {
        ...
        self.client_namespace
            .remove_id(crate::agent::ACTOR_CONTEXT, id)
    ...
    pub(crate) fn set_actor_id(
        ...
        self.client_namespace
            .replace_id(crate::agent::ACTOR_CONTEXT, current_id, new_id)
            .map_err(StateManagerError::from)?;
