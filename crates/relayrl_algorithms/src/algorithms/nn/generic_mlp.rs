    ...
    fn get_layer_specs(&self) -> LayerSpecs {
        self.layers
            ...
            .map(|layer| -> (usize, usize, Vec<f32>, Vec<f32>) {
                ...
                (dims[0], dims[1], weights, biases)//! Sample Factory's `convnet_simple` ConvNet policy for ViZDoom.
                //!
                ...
                use crate::algorithms::{
                    ArchLayer, LayerSpecs, NeuralNetwork, NeuralNetworkForward, NeuralNetworkSpec, WeightProvider,
                };
